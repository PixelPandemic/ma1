    ...
    setMessages(prevMessages => {
      return prevMessages.map(msg => {
        ...
        if (msg.isInitialMessage) {
          ...
          const superPowerMessage = '[Super Power]\n\n🚀 Welcome to the enhanced AI mode! I am now connected to advanced AI capabilities through OpenRouter.\n\nВ этом режиме я НЕ ограничен только информацией о платформе Meta ART!\n\nЯ могу:\n• Отвечать на вопросы по ЛЮБЫМ темам, не только о NFT и блокчейне\n• Писать и объяснять код на разных языках программирования\n• Помогать с техническими задачами и давать развернутые объяснения\n• Обсуждать новости, события, технологии и многое другое\n• Генерировать идеи, тексты и творческий контент\n\nСпрашивайте меня о чем угодно - в режиме Super Power я обладаю полным спектром возможностей искусственного интеллекта!';
